   ...
   < Navbar />
    <div className="min-h-screen bg-zinc-900 text-white p-6">
      ...
      >
        ...
        {/* Service Type */}
        <div>
          <label className="block text-sm mb-2 text-zinc-300">Service Type</label>
          <select
            name="serviceType"
        ...
        {/* Date */}
        <div>
          <label className="block text-sm mb-2 text-zinc-300">Preferred Date</label>
          <input
            type="date"
            name="date"
            value={formData.date}
        ...
        {/* Time */}
        <div>
          <label className="block text-sm mb-2 text-zinc-300">Preferred Time</label>
          <input
            type="time"
            name="time"
            value={formData.time}
        ...
        {/* Notes */}
        <div>
          <label className="block text-sm mb-2 text-zinc-300">Additional Notes</label>
          <textarea
            name="notes"
            rows="3"
