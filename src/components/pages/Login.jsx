...
const Login = () => {
  ...
  return (
      ...
      <div className="absolute top-6 right-6">
        <button 
          onClick={toggleTheme}
          className={`p-2 rounded-full transition-all duration-300 ${theme === 'light' ? 'bg-teal-100 text-teal-700 hover:bg-teal-200' : 'bg-gray-700 text-yellow-300 hover:bg-gray-600'}`}
        >
          {theme === 'light' ? (
      ...
      <div className={`w-full max-w-md p-8 rounded-2xl shadow-xl ${theme === 'light' ? 'bg-white' : 'bg-gray-800'} backdrop-blur-lg transition-all duration-300`}>
        <div className="text-center mb-8">
          <h1 className={`text-3xl font-bold ${theme === 'light' ? 'text-teal-600' : 'text-teal-400'}`}>Welcome Back</h1>
          <p className={`mt-2 ${theme === 'light' ? 'text-gray-600' : 'text-gray-300'}`}>Log in to your account</p>
        </div>

        <div className="space-y-5 mb-6">
          <div className={`relative ${theme === 'light' ? 'text-gray-700' : 'text-gray-200'}`}>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg ${theme === 'light' ? 'bg-gray-50 border border-gray-200' : 'bg-gray-700 border border-gray-600'} focus:outline-none focus:ring-2 ${theme === 'light' ? 'focus:ring-teal-500' : 'focus:ring-teal-400'} transition-all`}
              />
            </div>
          </div>
          ...
          <div className={`relative ${theme === 'light' ? 'text-gray-700' : 'text-gray-200'}`}>
            <div className="flex justify-between items-center mb-1">
              ...
              <a href="#" className={`text-xs ${theme === 'light' ? 'text-teal-600 hover:text-teal-700' : 'text-teal-400 hover:text-teal-300'}`}>
                Forgot password?
              </a>
            </div>
            <div className="relative">
          ...
          <div className="flex items-center">
            <input
              ...
              name="remember-me"
              type="checkbox"
              className={`h-4 w-4 rounded ${theme === 'light' ? 'border-gray-300 text-teal-600 focus:ring-teal-500' : 'border-gray-600 text-teal-500 focus:ring-teal-400'}`}
            />
            <label htmlFor="remember-me" className={`ml-2 block text-sm ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>
        ...
        <button
          onClick={handleLogin}
          disabled={isLoading}
          className={`w-full py-3 px-4 mb-4 rounded-lg font-medium transition-all duration-300 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''} 
            ${theme === 'light' 
        ...
        <div className="my-6 relative">
          <div className="absolute inset-0 flex items-center">
            <div className={`w-full border-t ${theme === 'light' ? 'border-gray-200' : 'border-gray-700'}`}></div>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className={`px-2 ${theme === 'light' ? 'bg-white text-gray-500' : 'bg-gray-800 text-gray-400'}`}>Or sign in with</span>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className={theme === 'light' ? 'text-gray-600' : 'text-gray-400'}>
            ...
            <Link to="/signup" className={`font-medium ${theme === 'light' ? 'text-teal-600 hover:text-teal-700' : 'text-teal-400 hover:text-teal-300'}`}>
              Sign up
            </Link>
          </p>
        </div>
