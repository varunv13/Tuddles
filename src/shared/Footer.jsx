...
const Footer = () => {
  return (
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row">
          ...
          <div className="md:w-[316px]">
            ...
            <div className="mt-3 flex gap-3 text-white">
              ...
              <a href="#"><FaInstagram size={20} className="hover:text-pink-500" /></a>
              <a href="#"><FaLinkedinIn size={20} className="hover:text-blue-400" /></a>
            </div>
          </div>
          ...
          <div className="md:w-[316px] flex flex-col gap-4">
            <div className="flex items-start gap-3">
              <svg width={20} height={20} fill="white" viewBox="0 0 24 24"><path d="..." /></svg>
              <div>
                <a href="tel:+911800123444" className="text-white font-medium text-[14px]">+91 1800 123 444</a>
            ...
            <div className="flex items-start gap-3">
              <svg width={20} height={20} fill="white" viewBox="0 0 24 24"><path d="..." /></svg>
              <div>
                <a href="mailto:help@tuddles.com" className="text-white font-medium text-[14px]">help@tuddles.com</a>
            ...
            <div className="flex items-start gap-3">
              <svg width={20} height={20} fill="white" viewBox="0 0 24 24"><path d="..." /></svg>
              <div>
                <p className="text-white font-medium text-[14px]">Kolkata , West Bengal, India 700001</p>
          ...
          <div className="flex flex-col gap-4 md:w-[341px]">
            <div>
              ...
              <div className="grid grid-cols-2 gap-y-1 text-[14px] text-white/80">
                ...
                <a className="hover:text-white" href="/our-tutors">News</a>
                <a className="hover:text-white" href="/contact">Contact</a>
                <a className="hover:text-white" href="/plans-and-pricing">Plans</a>
                <a className="hover:text-white" href="/terms-and-conditions">Terms</a>
    ...
    <div className="h-[56px] transition-transform duration-200 hover:scale-105"    >
      <p className="text-white text-[16px] font-semibold mb-2">Get the App</p>
