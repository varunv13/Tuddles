      ...
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl h-full px-4 mx-auto">
        ...
        <div className="flex items-center lg:order-2">
          ...
          >
            ...
            >
              {name?.substring(0, 2)?.toUpperCase() || "Profile"}
            </span>
            <svg
              strokeLinecap="round"
        ...
        >
          <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <Navbutton destination={'/vet'} label={'Vet'} active={currentRoute=='vet'}/>
            </li>
            <li>
              <Navbutton destination={'/contact'} label={'Contact'} active={currentRoute=='contact'}/>
            </li>
            <li>
              <Navbutton destination={'/adapt'} label={'Adopt'} active={currentRoute=='adapt'}/>
            </li>
